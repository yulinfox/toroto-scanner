...
def Scan(file):
    ...
    warped = four_point_transform(orig, screenCnt.reshape(4, 2) * 1.0)
...
def scan_2_base64(file):
     return cv2.imencode('.jpg', Scan(file))[1]
...
if __name__ == "__main__":
    ...
    with open("../images/receipt.jpeg", "rb") as f:
        file = f.read()

    result =  Scan(file)
    cv2.imwrite('./results/output.jpg', result)
